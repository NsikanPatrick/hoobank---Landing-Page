    ...
    <section>
      <Element name="pricing">
        <div className="container">
          <div className="pricing-head_before relative mx-auto border-l border-r border-secondary pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            <h3
              className={`text-white font-poppins text-center font-bold text-5xl mb-10`}
            >
              Flexible pricing for teams of all sizes
            </h3>
            <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-secondary bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
              <button
